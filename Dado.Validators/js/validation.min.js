...
+b&&9223372036854775E3>=+b;case "SByte":return-128<=+b&&127>=+b;case "Single":return-3.402823E38<=+b&&3.402823E38>=+b;default:return-2147483648<=+b&&2147483647>=+b}}function RequiredFieldValidatorEvaluateIsValid(a){if("false"===a.ischeckboxlist)return ValidatorTrim(ValidatorGetValue(a.controltovalidate))!=ValidatorTrim(a.initialvalue);a=document.getElementById(a.controltovalidate).getElementsByTagName("input");for(var b=0;b<a.length;)if(a[b++].checked)return!0;return!1}
